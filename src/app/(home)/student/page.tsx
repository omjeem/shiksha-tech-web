...
import StudentForm, { StudentData } from '@/components/Student/StudentForm';
...
export default function StudentPage() {
  ...
  // This would normally come from an API call to your backend
  // For demo purposes, we're storing it in localStorage
  useEffect(() => {
    try {

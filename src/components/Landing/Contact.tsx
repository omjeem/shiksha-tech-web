      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Have questions about our products, services, or pricing? Reach out to our team.
          </p>
        </div>
        
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12">
          <div className="md:w-2/5">
            <div className="rounded-lg bg-blue-50 p-8 h-full">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@shikshatech.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 Education St, Delhi, India 110001</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-blue-100 hover:bg-blue-200 transition-colors duration-300 rounded-full p-3">

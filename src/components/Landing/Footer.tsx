      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="font-bold text-xl">Shiksha Tech</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#app-download" className="text-gray-400 hover:text-white transition-colors duration-300">
                  Download App
                </Link>
              </li>
            </ul>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">
                  123 Education St, Delhi, India 110001
                </span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-1 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Shiksha Tech Education. All rights reserved.
          </p>
